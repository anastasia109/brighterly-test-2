...
for (i = 0; i < l; i++) {
    ...
    b.setAttribute("class", "custom-select__items custom-select__hide");
    for (j = 1; j < ll; j++) {
    ...
    a.addEventListener("click", function(e) {
        ...
        e.stopPropagation();
        closeAllSelect(this);
        this.nextSibling.classList.toggle("custom-select__hide");
...
function closeAllSelect(elmnt) {
    ...
    for (i = 0; i < xl; i++) {
        if (arrNo.indexOf(i)) {
            x[i].classList.add("custom-select__hide");
        }
    }
}
